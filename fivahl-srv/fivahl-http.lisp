...
<head>
  ...
  <script type='text/javascript'>
    ...
    function my_valid() {
      parent.hidden.document.input_form.action_text.value = '';
...
<body onload='javascript:set_place();'>
  ...
  <form action='' method='post' id='input_form' name='input_form' enctype='application/x-www-form-urlencoded'>
    ...
    <p>
      <input type='text' id='action_text' name='action_text' value='' size='80' onKeyPress='return submitenter(this,event)'>
      <input type='button' value='Envoyer' name='Envoyer' onclick='javascript:my_valid();'>
      <input type='button'  onclick='javascript:my_clear();' value='Effacer'>
    </p>
  </form>
